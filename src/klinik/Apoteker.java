...
public class Apoteker extends javax.swing.JFrame {
    ...
    txtid_apoteker.setEditable(true);
...
try {
    ...
    rs = st.executeQuery("SELECT * FROM apoteker ORDER BY id_apoteker ASC");
    ...
    tblData.setModel(model);
        ...
        private String cekIDapoteker;
        private void cekIDapoteker()
        {
            try {
            st = cn.createStatement();
            rs = st.executeQuery("SELECT COUNT(*) as total FROM obat WHERE id_apoteker = '" + txtid_apoteker.getText() + "'");
            
            while (rs.next()) {
                this.cekIDapoteker = rs.getString("total");
            }
            
            if (Integer.parseInt(cekIDapoteker) > 0) {
                btnHapus.setEnabled(false);
            } else {
        ...
        try {
            ...
            Integer.parseInt(txttelp_apoteker.getText());
    ...
    private void initComponents() {
        ...
        txttelp_apoteker.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txttelp_apotekerActionPerformed(evt);
            }
        });
...
//          e.printStackTrace();
    ...
    private void tblDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDataMouseClicked
        ...
        txtid_apoteker.setEditable(false);
        cekIDapoteker();

    }//GEN-LAST:event_tblDataMouseClicked

    private void txttelp_apotekerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txttelp_apotekerActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txttelp_apotekerActionPerformed
